    ...
    <div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr', gap:20, marginBottom:20 }}>
            ...
            <div style={{ background:'#eff6ff', border:'1px solid #bfdbfe', borderRadius:12, padding:24 }}>
              ...
              <div style={{ display:'flex', gap:20, flexWrap:'wrap' }}>
                {vendor.primary_contact && (
                  <div>
                    <div style={{ fontSize:11, color:'#94a3b8', fontWeight:600, marginBottom:2 }}>CONTACT</div>
                    <div style={{ fontSize:13, color:'#1e293b' }}>{vendor.primary_contact}</div>
                  </div>
                )}
                {vendor.phone && (
                  <div>
                    <div style={{ fontSize:11, color:'#94a3b8', fontWeight:600, marginBottom:2 }}>PHONE</div>
                    <a href={`tel:${vendor.phone}`} style={{ fontSize:13, color:BLUE, textDecoration:'none' }}>{vendor.phone}</a>
                  </div>
                )}
                {vendor.email && (
                  <div>
                    <div style={{ fontSize:11, color:'#94a3b8', fontWeight:600, marginBottom:2 }}>EMAIL</div>
                    <a href={`mailto:${vendor.email}`} style={{ fontSize:13, color:BLUE, textDecoration:'none' }}>{vendor.email}</a>
                  </div>
                )}
                {vendor.website && (
                  <div>
                    <div style={{ fontSize:11, color:'#94a3b8', fontWeight:600, marginBottom:2 }}>PORTAL</div>
                    <a href={vendor.website} target="_blank" rel="noopener noreferrer" style={{ fontSize:13, color:BLUE, textDecoration:'none' }}>Open Portal →</a>
                  </div>
                )}
              </div>
            </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
          ...
          {/* Vendor quick actions if assigned */}
          {vendor && (
